...
async def start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        ...
        "*Доступные команды:*\n"
        "/start — это сообщение\n"
        "/truck — ваши фуры (до 3): добавить, настроить, время поиска\n"
        "/location — указать город, где стоит фура (геофильтр по городу)\n"
        "/cancel — отменить текущую настройку\n\n"
        "Меню команд также доступно по кнопке *«/»* слева от поля ввода.\n\n"
        "Добавьте фуру через /truck, укажите город через /location и включите поиск на 1–2 дня."
    )
